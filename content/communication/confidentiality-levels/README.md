...
We make things public by default because [freedom is one of our values](https://www.redhat.com/en/about/brand/standards/culture).
...
1. All external communications about any financal information should be in line with the company's [SAFE Guidelines](/legal/safe-framework/).
...
1. Discussions that involve decisions related to country of residence are not public as countries are a core part of people's identity and any communication should have complete context.
...
1. Specific details about our hiring processes such as our scoring rubrics & criteria are not public as we want to ensure candidates provide an accurate overview of their experience and do not falsify their responses to meet our criteria.
...
1. Deals with external parties like contracts and approving and paying invoices.
1. Content that would violate confidentiality for a RedHat team-member, customer, or user.
...
1. Some information is kept confidential by the Security Team to protect the privacy, safety, and security of team members and applicants, including: job applications, background check reports, reference checks, compensation, terminations details, demographic information (age and date of birth, family or marital status, national identification such as passport details or tax ID, required accommodations), home address. Whistleblower identity is likewise confidential. Performance improvement plans, disciplinary actions, as well as individual feedback are restricted as they may contain negative feedback and negative feedback is 1-1 between you and your manager.
1. Performance improvement plans, disciplinary actions, as well as individual feedback, are confidential as they contain private negative feedback and negative feedback is 1-1 between team members and managers
1. Acquisition offers for us are not public since informing people of an acquisition that might not happen can be very disruptive
1. Acquisition offers we give are not public since the organization being acquired frequently prefers to have them stay private.
1. Compensation Changes: RedHat will communicate and train team members on the output of iterations to the Total Rewards offerings (Compensation, Equity, Benefits), but team members will not have visibility into the inputs and decision making of compensation changes.